...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController.navigationBar.tintColor = [UIColor orangeColor];
    UIView*backgroundview = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 320, 460)];
    backgroundview.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"image1.png"]];
